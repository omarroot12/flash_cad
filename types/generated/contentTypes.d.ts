...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    main_section: Schema.Attribute.Relation<
      'oneToOne',
      'api::main-section.main-section'
    >;
    publishedAt: Schema.Attribute.DateTime;
    question: Schema.Attribute.RichText;
    sub_section: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiSubscribedSubscribed extends Struct.CollectionTypeSchema {
